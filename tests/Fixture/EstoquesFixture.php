...
class EstoquesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_tbl_estoque_tbl_materiaprima1_idx' => ['type' => 'index', 'columns' => ['materia_prima_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_tbl_estoque_tbl_materiaprima1' => ['type' => 'foreign', 'columns' => ['materia_prima_id'], 'references' => ['materias_primas', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
